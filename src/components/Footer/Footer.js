...
import {
    CompanyContainer, FooterWrapper, LinkColumn, LinkItem, LinkList,
    LinkTitle, Slogan, SocialContainer, SocialIconsContainer
} from './FooterStyles';
        ...
        <FooterWrapper>
            <LinkList>
                <LinkColumn>
                    ...
                    <LinkItem href="tel:254752523326">Call Magpiny</LinkItem>
            ...
            <div style={{
                display: "flex", justifyContent: "center", backgroundColor: "white", color: "black",
